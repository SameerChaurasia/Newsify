import 'dart:convert';
import 'package:newsify/news_view.dart';
import 'package:newsify/category.dart';
...
class _HomeState extends State<Home> {
  ...
  getNewsofIndia() async {
    String url =
        "https://newsapi.org/v2/top-headlines?country=in&apiKey=47c6fa23df884f6996bf8115c27ec79b";
    Response response = await get(Uri.parse(url));
    Map data = jsonDecode(response.body);
    setState(() {
